...
<%
	...
	String imgDirPath = "D:\\WD2A\\fileUploadProj01\\src\\main\\webapp\\image\\";
	int maxSize = 1024 * 1024 * 5; // 5GB
...
%>
	...
	<p>유저가 업로드된 원본 파일 이름 : <%=originalFileName %></p>
	<p>파일 타입 : <%=contentType %></p>
	<p>파일 크기 : <%=length %></p>

<%
	String driverName = "org.mariadb.jdbc.Driver";
	String url = "jdbc:mariadb://localhost/db_kdh57_mall";
	String user = "root";
	...
	try {
		...
		if(result == 1) {
			out.println("<h2>데이터 베이스 입력 성공</h2>");
		} else {
			out.println("<h2>데이터 베이스 입력 실패</h2>");
		}
